...
begin
	if not exists (select nome from Atletas where nomeAtleta = nome and dataNascimento = dataNasc and sexo = sexoAtl and altura = alturaAtl and peso = pesoAtl and codCidade = codCid) then
